...
class CSmoke_Effect : public CEffect_Base
{
public:
...
private:
	...
	CSmoke_Effect(const CSmoke_Effect& rhs);

public:
	virtual ~CSmoke_Effect();
...
public:
	static shared_ptr<CSmoke_Effect> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);

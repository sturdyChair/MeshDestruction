...
class CTexture_Effect : public CEffect_Base
{
public:
...
public:
	static shared_ptr<CTexture_Effect> Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);

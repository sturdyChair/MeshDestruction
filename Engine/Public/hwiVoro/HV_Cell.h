...
class HWIVORO_DLL CHV_Cell_Base
{
#pragma region METHOD
public:
	CHV_Cell_Base();
	virtual ~CHV_Cell_Base();
...
protected:
	...
	template<class vc_class>
	void check_memory_for_copy(vc_class& vc, CHV_Cell_Base* vb);
	void copy(CHV_Cell_Base* vb);
private:
	template<class vc_class>
...
#pragma endregion //DATA
	friend class CHV_Cell;
	friend class CHV_Cell_Neighbor;
};



class HWIVORO_DLL CHV_Cell : public CHV_Cell_Base
{
public:
	using CHV_Cell_Base::nplane;
#pragma region METHOD
public:
	/** Copies the information from another CHV_Cell class into
		 * this class, extending memory allocation if necessary.
		 * \param[in] c the class to copy. */
	inline void operator=(CHV_Cell& c) {
		CHV_Cell_Base* vb((CHV_Cell_Base*)&c);
...
#pragma endregion //METHOD
	friend class CHV_Cell_Base;
};


class HWIVORO_DLL CHV_Cell_Neighbor : public CHV_Cell_Base
{
public:
	using CHV_Cell_Base::nplane;
...
public:
	CHV_Cell_Neighbor();
	~CHV_Cell_Neighbor();
	void operator=(CHV_Cell& c);
	void operator=(CHV_Cell_Neighbor& c);

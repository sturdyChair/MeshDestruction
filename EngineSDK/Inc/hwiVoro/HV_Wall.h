...
namespace hwiVoro {
	...
	struct HWIVORO_DLL wall_sphere : public wall {
	public:
		...
		bool cut_cell(CHV_Cell& c, double x, double y, double z) { return cut_cell_base(c, x, y, z); }
		bool cut_cell(CHV_Cell_Neighbor& c, double x, double y, double z) { return cut_cell_base(c, x, y, z); }
	private:
		const int w_id;
	...
	struct HWIVORO_DLL wall_plane : public wall {
	public:
	...
	struct HWIVORO_DLL wall_cylinder : public wall {
	public:
	...
	struct HWIVORO_DLL wall_cone : public wall {
	public:

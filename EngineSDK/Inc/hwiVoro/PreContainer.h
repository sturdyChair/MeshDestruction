...
namespace hwiVoro {
	...
	class HWIVORO_DLL pre_container_base {
	public:
	...
	class HWIVORO_DLL pre_container : public pre_container_base {
	public:
...
import(fp);
	...
	class HWIVORO_DLL pre_container_poly : public pre_container_base {
	public:
		/** The class constructor sets up the geometry of container,
		 * initializing the minimum and maximum coordinates in each
		 * direction.

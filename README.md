...
개발 기간 : 2025.03.31 ~ 2025.05.23   
기술 스택 : C++, DirectX 11, HLSL, Nvidia Physx

## 목적 및 설명   

디자이너에게 의존하지 않고 어떤 메쉬든 조각낼 수 있고, 물리적으로 시뮬레이션 할 수 있는 코드를 구현하기 위한 프로젝트입니다.   
스태틱 메쉬에 그치지 않고 스키닝된 캐릭터 메쉬 또한 실시간으로 파괴할 수 있습니다.   
**주요 로직은 외부 라이브러리를 전혀 사용하지 않고 직접 구현했습니다.**
